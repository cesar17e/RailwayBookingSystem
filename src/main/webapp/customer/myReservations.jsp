  ...
  <%
    ...
    try (Connection conn = DBUtil.getConnection();
      ...
      out.println("<table border='1'><tr>"
                + "<th>Date</th><th>Trip</th><th>Type</th>"
                + "<th>Fare</th><th>Passenger</th><th>Status</th><th>Action</th></tr>");
      while (rs.next()) {
        ...
        out.println("<tr>"
          ...
          +   ( "active".equals(rs.getString("status"))
                ? "<a href='cancelReservation.jsp?id=" + resId + "'>Cancel</a>"
                : "" )
          + "</td>"
          + "</tr>");
      }
